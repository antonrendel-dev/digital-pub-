...
const DESCRIPTION =
  'База резюме 2026: маркетологи, SMM-менеджеры, дизайнеры, аналитики из Telegram. Актуальные кандидаты на digital-вакансии — смотрите бесплатно, без регистрации.'
