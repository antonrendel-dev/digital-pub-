          ...
          <div className="space-y-8 text-sm text-text-muted leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                вакансию — перешёл напрямую к работодателю в Telegram. Никаких посредников и платных
                функций.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                посвящены поиску работы в digital. Мы отслеживаем каналы с вакансиями по маркетингу,
                SMM, дизайну, контенту, разработке и смежным специальностям.
              </p>
              <p className="mt-3">
            ...
            {/* Почему нам доверяют */}
            <section>
              <h2 className="text-lg font-semibold text-text mb-3">Прозрачность и актуальность</h2>
              <p>
                Мы не редактируем содержание вакансий и не фильтруем предложения по собственным
                критериям. Всё, что публикуется в открытых источниках — попадает к вам в неизменном
                виде со ссылкой на автора.
              </p>
              <p className="mt-3">
                Три принципа, на которых работает сервис. Первый — только публичные источники:
                парсим исключительно открытые Telegram-каналы, доступные любому пользователю. Второй
                — ежедневное обновление: база пополняется регулярно, устаревшие объявления удаляются
                автоматически. Третий — структура по специализациям: вакансии разбиты на 12
                категорий, чтобы вы сразу попали в нужный раздел.
              </p>
            </section>

            {/* Для кого */}
            <section>
              <h2 className="text-lg font-semibold text-text mb-3">Для кого создан Диджитал Паб</h2>
              <p>
                Прежде всего — для digital-специалистов, которые ищут работу: маркетологов,
                дизайнеров, SMM-менеджеров, таргетологов, аналитиков, разработчиков, копирайтеров и
                контент-мейкеров. Сервис одинаково полезен и тем, кто ищет штатную позицию, и
                фрилансерам в поиске проектной занятости.
              </p>
              <p className="mt-3">
                HR-специалисты и рекрутеры используют Диджитал Паб, чтобы разместить вакансию через
                наш{' '}
                <a
              ...
              <p className="mt-3">
                ...
                содержит анкеты digital-профессионалов, которые открыты к предложениям прямо сейчас.
              </p>
            </section>
            ...
            <section className="bg-bg-card border border-border rounded-xl p-6">
              ...
              <p>
                Хотите, чтобы ваша вакансия появилась на Диджитал Паб? Напишите нашему Telegram-боту
