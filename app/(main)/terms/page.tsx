    ...
    <PageShell>
      <div className="max-w-3xl mx-auto px-4 pt-6 pb-12">
        ...
        <div className="bg-bg-card border border-border rounded-xl p-7 text-sm text-text-muted leading-relaxed space-y-4">
          ...
          <p>
            Сервис Диджитал Паб (d-pub.ru) является агрегатором вакансий и резюме из публичных
            Telegram-каналов. Используя Сервис, вы соглашаетесь с настоящими Условиями.
          </p>

          <h2 className="text-lg font-semibold text-text">2. Контент</h2>
          <p>
            Вакансии и резюме, размещённые на Сервисе, получены из публичных Telegram-каналов.
            Администрация Сервиса не несёт ответственности за содержание объявлений, размещённых
            третьими лицами.
          </p>

          <h2 className="text-lg font-semibold text-text">3. Размещение объявлений</h2>
          <p>
            Для размещения вакансий и рекламы используйте нашего Telegram-бота:{' '}
            <a
          ...
          <p>
            Дизайн и структура Сервиса являются интеллектуальной собственностью Диджитал Паб.
            Копирование материалов допускается только со ссылкой на источник.
          </p>
        </div>
      </div>
    </PageShell>
