...
export const metadata: Metadata = {
  ...
  description:
    'Как составить резюме, пройти собеседование и вырасти в digital: разборы профессий, зарплатные вилки и инструкции для SMM, маркетологов, дизайнеров и аналитиков.',
