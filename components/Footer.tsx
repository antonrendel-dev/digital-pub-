          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://vk.com/digital_pub_vacancies" target="_blank" rel="noopener noreferrer" aria-label="ВКонтакте" className="text-text-light hover:text-brand-vk transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0z" />
                  <path d="M18.1 8.2h-1.85a.42.42 0 0 0-.37.22s-.74 1.36-.98 1.82c-.64 1.22-1.04.84-1.04.28V8.63a.62.62 0 0 0-.62-.62H11.84a1.12 1.12 0 0 0-.99.46s.71-.12.71.84c0 .24.01.92.02 1.49a.41.41 0 0 1-.72.28 12.13 12.13 0 0 1-1.41-2.56.39.39 0 0 0-.36-.23H7.4a.29.29 0 0 0-.27.39c.5 1.41 2.7 5.78 5.19 5.78h1.06a.42.42 0 0 0 .42-.42v-.64a.41.41 0 0 1 .69-.3l1.27 1.19a.62.62 0 0 0 .42.17h1.66c.8 0 .8-.56.36-.99-.31-.3-1.42-1.48-1.42-1.48a.58.58 0 0 1-.04-.75c.36-.47.95-1.25 1.2-1.58.34-.45.96-1.42.11-1.42z" fill="white" />
                </svg>
              </a>
            </div>
          </div>
