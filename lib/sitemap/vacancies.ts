...
const TOOL_REDIRECT_SLUGS = new Set([
  ...
  'photoshop',
  'wordpress',
  // Редирект /vacancies/vk-ads → /tools/vk-ads есть в конфиге с самого начала,
  // а в этом наборе слаг забыли. Пока тега vk-ads нет в базе, карточки под
  // таким адресом не появлялись — но стоило бы тегу завестись, и карта сайта
  // повела бы робота на редирект. Страж: tests/unit/tool-pages-consistency.
  'vk-ads',
])
