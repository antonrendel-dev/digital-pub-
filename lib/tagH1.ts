...
export const TAG_TITLE: Record<string, string> = {
  seo: `SEO-вакансии 2026 — {N} актуальных: удалённо и офис | Диджитал Паб`,
  udalyonka: `Удалённая работа digital 2026 — {N} вакансий: SMM, дизайн, маркетинг`,
  smm: `Вакансии SMM-менеджера — {N} актуальных, удалёнка и офис`,
  marketing: `Вакансии маркетолога 2026 — {N} актуальных: digital, performance, удалёнка`,
  target: `Вакансии таргетолога удалённо — {N} актуальных: VK, Директ`,
  razrabotka: `Вакансии разработчика — {N} актуальных: frontend, backend`,
  analitika: `Вакансии аналитика данных 2026 — {N} актуальных: веб, продукт, data`,
  menedzher: `Вакансии менеджера 2026 — {N} актуальных: проджект, продакт, аккаунт`,
  ...
  gibrid: `Вакансии гибрид в digital — {N}: Москва, СПб, офис + удалёнка`,
