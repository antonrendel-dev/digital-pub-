...
const DATA_DIR = path_1.default.join(SCRIPTS_DIR, 'data')
...
function getLatestTopicsFile() {
  if (!fs_1.default.existsSync(DATA_DIR)) return null
...
function runScript(script, args) {
  return new Promise((resolve, reject) => {
    const scriptPath = path_1.default.join(SCRIPTS_DIR, `${script}.compiled.js`)
