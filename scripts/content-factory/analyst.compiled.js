    ...
    if (agent) {
      if (supportsAgentProfiles(cli, agent)) {
        ...
        if (role) {
          ...
          console.log(
            `    \u26A0 ${agent}: \u043F\u0440\u043E\u0444\u0438\u043B\u044C \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D, \u0430\u0433\u0435\u043D\u0442 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0431\u0435\u0437 \u0440\u043E\u043B\u0438`
          )
        }
      }
    }
...
async function reformulateTopics(offTarget) {
  ...
  for (let round = 1; round <= REFORMULATION_ROUNDS && pending.length; round++) {
    console.log(
      `[analyst] \u041F\u0435\u0440\u0435\u0444\u043E\u0440\u043C\u0443\u043B\u0438\u0440\u043E\u0432\u043A\u0430, \u043A\u0440\u0443\u0433 ${round}: ${pending.length} \u0442\u0435\u043C`
    )
...
[{"id": <\u0438\u0441\u0445\u043E\u0434\u043D\u044B\u0439 id>, "title": "\u043D\u043E\u0432\u044B\u0439 \u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A", "keyword": "\u043D\u043E\u0432\u044B\u0439 \u043A\u043B\u044E\u0447"}]`,
    ...
    if (!jsonMatch) {
      console.warn(
        '[analyst] \u041F\u0435\u0440\u0435\u0444\u043E\u0440\u043C\u0443\u043B\u0438\u0440\u043E\u0432\u043A\u0430: Claude \u043D\u0435 \u0432\u0435\u0440\u043D\u0443\u043B JSON, \u043E\u0441\u0442\u0430\u0432\u043B\u044F\u044E \u0442\u0435\u043C\u044B \u043A\u0430\u043A \u0435\u0441\u0442\u044C'
      )
      break
    }
