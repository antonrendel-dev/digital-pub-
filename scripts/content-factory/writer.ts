...
2. ФАКТЫ:
   - Найди выдуманные конкретные цифры (точные суммы зарплат, точная численность без источника) — замени диапазоном: «по данным крупных job-платформ — от N до M»
   - Убедись что есть минимум 3 факта/данных с указанием источника (hh.ru, SuperJob, Яндекс.Работа, Росстат)

3. СТИЛЬ — редактируй именно как главред Максим Ильяхов («Пиши, сокращай»):
   - Убирай вводные слова и канцеляризм (осуществлять → делать, является → есть, в рамках → в)
   - Пассивный залог → активный («было сделано» → «сделали»)
   - Убирай оценочные слова без доказательств («лучший», «эффективный», «уникальный», «актуальный»)
