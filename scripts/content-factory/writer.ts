...
PLURAL BRIDGE (9.9b): в первых 60 словах поставь мост ед./мн. числа по шаблону «[NAMED ЕД] — один из видов [NAMED МН], которые [действие] [число/факт].» Пример: «Аналитик данных — один из видов digital-специалистов, которых hh.ru насчитывает более 8 000 активных вакансий.»
