...
const JOB_INTENT = /ваканс|работа|зарплат|резюме|собеседован|нанять|стажировк|фриланс|портфолио|навык|обязанност|профессия|сколько (зараба|плат|получ)|кто это|чем занимается|с нуля|без опыта|курс|обучен/i
