...
const KNOWN_DEBT = [
  // Посадочные «спец × фильтр»: слаги из getAllFilterCombinations(), вакансии из БД.
  path.join('app', '(main)', 'vacancies', '[category]', '[slug]', 'page.tsx'),
  // Профессии: слаги из PROFESSION_SLUGS, листинг вакансий из БД.
  path.join('app', '(main)', 'professions', '[slug]', 'page.tsx'),
  // Статьи: текст из MDX и живёт без базы, Payload здесь только запасной путь.
