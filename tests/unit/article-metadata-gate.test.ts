...
describe('заголовок раздела вопросов', () => {
  ...
  // Ревью 02.09.2026 воспроизвело оба случая: функция вырезала ключевой H2 и
  // уводила грейды и шаги в faqSchema как вопросы.
  it('не переименовывает зарплатный H2 с грейдами под ним', () => {
    const grades =
      '## Кто это\n\nТекст.\n\n## Сколько зарабатывает продуктовый маркетолог?\n\n### Джуниор\n60 000 ₽.\n\n### Мидл\n120 000 ₽.\n'
    expect(normalizeFaqHeading(grades)).toBe(grades)
  })

  it('не переименовывает H2 с пошаговой инструкцией под ним', () => {
    const steps =
      '## Кто это\n\nТекст.\n\n## Что делать дальше?\n\n### Шаг 1. Собрать портфолио\nТекст.\n\n### Шаг 2. Откликнуться\nТекст.\n'
    expect(normalizeFaqHeading(steps)).toBe(steps)
  })
})
